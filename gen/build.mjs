...
/* claude chat widget */
.cw-fab{position:fixed;left:18px;bottom:18px;z-index:150;width:56px;height:56px;border-radius:50%;border:0;cursor:pointer;
...
.cw{position:fixed;left:18px;bottom:86px;z-index:151;width:min(400px,calc(100vw - 36px));max-height:min(640px,calc(100dvh - 110px));
...
@media(max-width:700px){.cw{left:12px;right:12px;width:auto;bottom:80px}.cw-fab{left:14px;bottom:14px}}
